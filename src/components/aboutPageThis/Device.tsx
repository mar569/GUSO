...
const Device: React.FC = () => {
    return (
        <div className="flex flex-col md:flex-row pt-22 relative w-full max-w-[1920px] h-[719px] mx-auto">
            <div className="flex-grow flex justify-center md:justify-end h-full w-full max-w-[900px] max-h-[517px] order-1 md:order-2">
                <DeviceVideo />
            </div>

            <div className="flex flex-col items-start max-w-[567px] max-h-[516px] justify-center order-2 md:order-1 md:ml-auto mr-11 mt-10 md:mt-0">
