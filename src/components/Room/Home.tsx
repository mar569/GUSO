...
const PrivateHome: React.FC = () => {
    ...
    return (
        <div className="relative w-full max-w-[1920px] mx-auto min-h-[852px] lg:h-[1080px]" id='favoritePlaces'>
            ...
            <div className={`relative mx-auto max-w-[${APP_CONFIG.maxWidth}] px-2 sm:px-8 flex flex-col pt-10 pb-20 transition-opacity duration-300 ${isTransitioning ? 'opacity-90' : 'opacity-100'} h-full`}>
