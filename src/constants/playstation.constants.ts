...
export const SLIDES: PlayStationItem[] = [
  ...
  },
  {
    id: 4,
    description:
      'apple tv 4k позволит показать любой контент как с твоего телефона, так и с любимого сервиса',
  ...
  },
  {
    id: 5,
    description:
      'стриминговые сервисы для просмотра спортивных трансляции и фильмов в 4к. Смотри вместе с друзьями',
